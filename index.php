<?php
    ...
    $N = 0; //Contador de cuadras caminadas por el ebrio
    $Y = 0; //Cuadras caminadas en dirección del eje Norte(+) - Sur(-)
    $X = 0; //Cuadras caminadas en dirección del eje Este(+) - Oeste(-)
